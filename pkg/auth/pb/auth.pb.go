...
func (x *RegisterResponse) GetError() int64 {
	if x != nil {
		return x.Error
	}
	return 0
...
func (x *LoginResponse) GetError() int64 {
	if x != nil {
		return x.Error
	}
	return 0
...
func (x *ValidateResponse) GetError() int64 {
	if x != nil {
		return x.Error
	}
	return 0
...
var file_pkg_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x27, 0x0a, 0x0f,
	...
	0x73, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
